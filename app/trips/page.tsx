...
export default async function TripsPage() {
    ...
    if (!session) {
        return (<div className="flex justify-centeritems-center h-screen text-gray-700 text-xl">
            {""}
            Please Sign In
        </div>
        );
        ...
        <Card>
                ...
                <p>
                    {trips.length === 0 
                        ...
                        : `You have ${trips.length} ${
                            trips.length === 1 ? "trip" : "trips"} planned. ${upcomingTrips.length > 0
            ...
            <div>
                ...
                {trips.length === 0 ?(
                    <Card>
                        <CardContent className="flex flex-col items-center justify-center py-8">
                            ...
                            <p className="text-center mb-4 max-w-md">
                                Start planning your first trip by clicking the button.
                            </p>
                            <Link href="/trips/new"> 
                                <Button>New Trip</Button>
                            </Link>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 p">
